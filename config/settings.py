...
SECRET_KEY = os.environ.get('SECRET_KEY', default="S3cret_23bGd")
...
# Hosts Settings
ALLOWED_HOSTS = ['*']
CSRF_TRUSTED_ORIGINS = ['http://localhost:8000', 'http://localhost:5085', 'http://127.0.0.1:8000', 'http://127.0.0.1:5085', 'https://platform.e-farm.ro']
...
SITE_URL = os.getenv("SITE_URL", default="https://platform.e-farm.ro")
